...
import NursingManageSystem.MainApp;
...
import NursingManageSystem.tools.SimpleTools;
...
public class MainFrameController2 {

    private User user = LogUpFrameController.user;
    ...
    public void do_addButton_event(ActionEvent event) {
        ...
        try {
            ...
            loader.setLocation(getClass().getResource("NursingManageSystem/view/logupFrame.fxml"));
